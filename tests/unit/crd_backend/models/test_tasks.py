...
class TestTaskModel:
    ...
    def test_task_invalid_transitions(self, db_session, team):
        ...
        with pytest.raises(ValueError, match="Cannot complete task in"):
            task.complete()
        ...
        with pytest.raises(ValueError, match="Cannot start task in"):
            task.start()
        ...
        with pytest.raises(ValueError, match="Cannot fail task in"):
            task.fail("error")
